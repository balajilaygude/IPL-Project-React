...
function Home() {
  ...
  //Accesing the Object Which have matchDetailsMap propreties
...
//   console.log(filterData)
  ...
  return (
    <div className='w-screen min-h-full mt-5 flex justify-center items-center'>
           <div className="sm:grid grid-cols-2 sm:mx-4 mx-4">
        {matchData.map(({matchDetailsMap:{match,key}},i)=>(
            match.map(({matchInfo :{team1,matchDesc,matchFormat,team2,status,matchId},matchScore})=>(
                <Link to={`/matchdetail/${matchId}`} key={matchId} >
                    <div className="border-2 flex flex-col gap-5 m-1 p-2">
                        ...
                        <div >
                            <div className=" flex justify-between items-center">
                                <div className='flex gap-5 justify-center items-center'>
                                    <img className='w-8 h-8'
                                     src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/${team1.imageId}`} alt="" />
                                <p>{team1.teamSName}</p>
                                </div>
                            ...
                            <div className=" flex justify-between items-center">
                                <div className='flex gap-5 justify-center items-center'>
                                <img className='w-8 h-8'
                                src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/${team2.imageId}`} alt="" />
                                <p>{team2.teamSName}</p>
                                </div>
